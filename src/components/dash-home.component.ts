...
@Component({
    ...
    `,
    imports: [RouterOutlet, SideNavigationComponent, MainContentComponent, MainMetricsComponent, WeekMetricsComponent, WeekCalendarDisplayComponent, InfoBarComponent, LoginFormWrapper]
})
